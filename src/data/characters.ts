...
export const characterProfiles: Record<string, CharacterProfile> = {
  boss: {
    ...
    accentColor: '#ff654e',
    assetVersion,
    stageFraming: 'closeup',
    closeupFrame: 'reactionCloseup',
...
export const bossFinaleFrames: Record<BossFinaleFrameKey, string> = {
  entrance: 'art/pixel-vn-v3/boss/entrance.webp',
  impact: 'art/pixel-vn-v3/boss/impact.webp',
  breakdown: 'art/pixel-vn-v3/boss/breakdown.webp',
  bonk: 'art/pixel-vn-v3/boss/bonk.webp',
  defeated: 'art/pixel-vn-v3/boss/defeated.webp',
}

export const bossFinaleBeats: BossFinaleBeat[] = [
  { id: 'entrance', startMs: 0, endMs: 1200, frame: 'entrance', spriteSheet: bossFinaleFrames.entrance, frameCount: 2, frameDurationMs: 360, loop: true, impact: 'hold' },
  { id: 'impact', startMs: 1200, endMs: 3000, frame: 'impact', spriteSheet: bossFinaleFrames.impact, frameCount: 3, frameDurationMs: 130, loop: true, impact: 'shock', soundCue: 'strike', callout: '术语命中!' },
  { id: 'breakdown', startMs: 3000, endMs: 5600, frame: 'breakdown', spriteSheet: bossFinaleFrames.breakdown, frameCount: 4, frameDurationMs: 120, loop: true, impact: 'breakdown', soundCue: 'alarm', callout: '红温!' },
  { id: 'bonk', startMs: 5600, endMs: 7600, frame: 'bonk', spriteSheet: bossFinaleFrames.bonk, frameCount: 3, frameDurationMs: 115, loop: true, impact: 'bonk', soundCue: 'bonk', callout: 'BONK!' },
  { id: 'defeated', startMs: 7600, endMs: 10000, frame: 'defeated', spriteSheet: bossFinaleFrames.defeated, frameCount: 2, frameDurationMs: 420, loop: true, impact: 'finish', soundCue: 'stamp' },
]
